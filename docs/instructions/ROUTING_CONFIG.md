...
function creatr {
    ...
    switch ($Task) {
        ...
        "review" {
            Write-Host "Routing to Claude Code (Post-Session Eval)"
            claude "Run the Post-Session Eval in AGENTS.md Section 12 against this session."
        }
    }
}
...
creatr() {
    ...
    case "$task" in
        ...
        inline)
            ...
            ;;
        review)
            echo "Routing to Claude Code (Post-Session Eval)"
            claude "Run the Post-Session Eval in AGENTS.md Section 12 against this session."
            ;;
        *)
