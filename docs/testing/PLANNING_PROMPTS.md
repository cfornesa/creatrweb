...
MEMORY.md (if lessons confirmed), AGENTS.md Section 12 (if evaluation
...
review→Claude Code via AGENTS.md Section 12 (full spec compliance,
...
MEMORY.md (if lessons confirmed this session),
AGENTS.md Section 12 (required — review criteria must be confirmed
