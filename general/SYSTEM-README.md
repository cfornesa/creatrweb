...
**Use this variant** for a new or lightly-documented repo, where a clean install is what you want. If the repo already has agentic markdown you'd rather adapt than sit beside, use `general_starter/` instead.
...
```
general/.claude/skills/gallery-format/  →  <your repo>/.claude/skills/gallery-format/
general/.agents/skills/gallery-format/  →  <your repo>/.agents/skills/gallery-format/
```
